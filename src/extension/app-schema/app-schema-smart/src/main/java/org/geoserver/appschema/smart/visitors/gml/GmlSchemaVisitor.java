...
import static org.geoserver.appschema.smart.visitors.gml.GmlSchemaUtils.buildGmlSchemaDocument;
import static org.geoserver.appschema.smart.visitors.gml.GmlSchemaUtils.createComplexAttributeElementNode;
import static org.geoserver.appschema.smart.visitors.gml.GmlSchemaUtils.createFeatureElementNode;
import static org.geoserver.appschema.smart.visitors.gml.GmlSchemaUtils.createFeatureTypeNode;
import static org.geoserver.appschema.smart.visitors.gml.GmlSchemaUtils.createPropertyTypeNode;
import static org.geoserver.appschema.smart.visitors.gml.GmlSchemaUtils.createSimpleAttributeElementNode;
import static org.geoserver.appschema.smart.visitors.gml.GmlSchemaUtils.getFeatureElementNodeByName;
...
public final class GmlSchemaVisitor extends DomainModelVisitorImpl {
    ...
    private static final Logger LOGGER = Logging.getLogger(GmlSchemaVisitor.class);
    ...
    public void visitDomainRelation(DomainRelation relation) {
        ...
        Node featureTypeNode = getFeatureElementNodeByName(gmlDocument, relation.getContainingEntity().getName()+"Type");

...
public final class AppSchemaVisitor extends DomainModelVisitorImpl {
    ...
    public void visitDomainRelation(DomainRelation relation) {
        ...
        String containingTargetElementValue =
        		this.targetNamespacePrefix + ":" + relation.getContainingEntity().getName() + TABLE_SUFFIX;
        String destinationTargetElementValue =
        		this.targetNamespacePrefix + ":" + relation.getDestinationEntity().getName() + TABLE_SUFFIX;
        ...
        Node destinationAttributeMappingNode = createAttributeMapping(appDocument, linkName, relation.getDestinationKeyAttribute().getName());
        ...
        Node attributeMappingNode =
                createLinkedAttributeMapping(appDocument,
    ...
    private Node handleEntity(DomainEntity entity) {
        ...
        String targetElementValue = this.targetNamespacePrefix + ":" + entity.getName() + TABLE_SUFFIX;
        ...
        featureTypeMappingNode = createFeatureTypeMappingNode(appDocument, sourceDataStoreValue, sourceTypeValue, targetElementValue);

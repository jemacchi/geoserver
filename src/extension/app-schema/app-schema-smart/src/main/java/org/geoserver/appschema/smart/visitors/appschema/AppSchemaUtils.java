...
public final class AppSchemaUtils {
    ...
    static Document initiateAppSchemaDocument(Document document, String targetNamespacePrefix, String targetNamespaceUrl) {
    	// root node
    ...
    /** 
     * Helper method that allows to get the sourceDataStores node from a given document. 
     * Method is assuming that there is only one element with sourceDataStores tagname.
     */
    ...
    /** 
     * Helper method that allows to get the typeMappings node from a given document. 
     * Method is assuming that there is only one element with typeMappings tagname.
     */
     ...
     * </FeatureTypeMapping>}
     */
	static Element createFeatureTypeMappingNode(Document document, String sourceDataStoreValue, String sourceTypeValue, String targetElementValue) {
	...
	static Node getAttributeMappings(Node featureTypeMapping) {
	...
	/** Helper method that allows to get the an attributeMapping node for a given featureTypeMapping and targetAttributeValue. */
	...
	/** 
	 * Helper method that allows to get the number of linked attributesMappings occurencies in a given featureTypeMapping. 
	 * This helper allows to get the index number that will be used in FEATURE_LINK[INDEX_NUMBER] references.
	 */

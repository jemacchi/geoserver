...
public class JdbcDataStoreMetadataConfig extends DataStoreMetadataConfig {
    ...
    public JdbcDataStoreMetadataConfig(String name, String driver, String url, String user, String pass, String catalog, String schema) {
        super();
        this.name = name;
        try {
			...
			throw new RuntimeException("JdbcDataStoreMetadataConfig: Cannot get connection to DataStoreMetadata.");
		}
	...
	public Map<String, String> getParameters() {
		...
		try {
			...
			// in case dbtype = postgresql, then translate it to postgis (since geoserver would not understand it in 
			// appschema context

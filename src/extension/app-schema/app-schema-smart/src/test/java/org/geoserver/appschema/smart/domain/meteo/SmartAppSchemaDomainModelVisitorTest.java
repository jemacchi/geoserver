...
public final class SmartAppSchemaDomainModelVisitorTest extends SmartAppSchemaPostgisTestSupport {
    ...
    public void testObservationsRootEntity() throws Exception {
        ...
        SmartAppSchemaDomainModelVisitor dmv = new SmartAppSchemaDomainModelVisitor(NAMESPACE_PREFIX, TARGET_NAMESPACE, "./meteo-observations-gml.xsd");
        dm.accept(dmv);
        
        InputStream is = SmartAppSchemaTestHelper.getFileFromResourceAsStream("meteo-observations-appschema.xml");
    ...
    public void testStationsRootEntity() throws Exception {
        ...
        InputStream is = SmartAppSchemaTestHelper.getFileFromResourceAsStream("meteo-stations-appschema.xml");
        DocumentBuilderFactory dbFactory = DocumentBuilderFactory.newInstance();
    	DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();
        Document control = dBuilder.parse(is);  

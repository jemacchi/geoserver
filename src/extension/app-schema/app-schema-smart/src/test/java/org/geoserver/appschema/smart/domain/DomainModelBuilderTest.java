...
public class DomainModelBuilderTest extends SmartAppSchemaPostgisTestSupport {
    ...
    public void testDomainModelBuilderWithStationsAsRoot() throws Exception {
        ...
        String containingEntityNameMeteoStationsRelation = meteoStationRelation.getContainingEntity().getName();
        String destinationEntityNameMeteoStationsRelation = meteoStationRelation.getDestinationEntity().getName();
        int meteoObservationsRelationsSize = meteoStationRelation.getDestinationEntity().getRelations().size();
        DomainRelation meteoObservationRelation = meteoStationRelation.getDestinationEntity().getRelations().get(0);
        String destinationEntityNameMeteoObservationsRelation = meteoObservationRelation.getDestinationEntity().getName();
        int meteoParamatersRelationsSize = meteoObservationRelation.getDestinationEntity().getRelations().size();
    ...
    public void testDomainModelBuilderWithParametersAsRoot() throws Exception {
        ...
        String containingEntityNameMeteoParametersRelation = meteoParameterRelation.getContainingEntity().getName();
        String destinationEntityNameMeteoParametersRelation = meteoParameterRelation.getDestinationEntity().getName();
        int meteoObservationsRelationsSize = meteoParameterRelation.getDestinationEntity().getRelations().size();
        DomainRelation meteoObservationRelation = meteoParameterRelation.getDestinationEntity().getRelations().get(0);
        String destinationEntityNameMeteoObservationsRelation = meteoObservationRelation.getDestinationEntity().getName();
        int meteoStationsRelationsSize = meteoObservationRelation.getDestinationEntity().getRelations().size();
    ...
    public void testDomainModelBuilderWithObservationsAsRoot() throws Exception {
        ...
        // check relations containing and destination entity, as much as relations from that entities
        ...
        map.forEach((destinationKey, relation) -> {

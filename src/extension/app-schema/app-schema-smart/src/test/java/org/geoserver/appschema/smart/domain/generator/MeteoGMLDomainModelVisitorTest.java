...
public final class MeteoGMLDomainModelVisitorTest extends JDBCTestSupport {
    ...
    public void testObservationsRootEntity() throws Exception {
        ...
        SmartAppSchemaTestHelper.saveDocumentToFile(dmv.getDocument(), "/home/jmacchi/observations-gml.xsd");
    ...
    public void testStationsRootEntity() throws Exception {
        ...
        SmartAppSchemaTestHelper.printDocument(dmv.getDocument(), System.out);
        SmartAppSchemaTestHelper.saveDocumentToFile(dmv.getDocument(), "/home/jmacchi/stations-gml.xsd");
